        ...
        <CardHeader className="flex flex-col gap-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div className="flex flex-col">
              ...
              <div className="text-sm text-gray-400 sm:hidden">Total Resources: {totalResources}</div>
            </div>
            <div className="text-sm text-gray-400 hidden sm:block">Total Resources: {totalResources}</div>
          </div>
